<?php
$pageTitle = 'Nintendo Homebrew | Rules';
...
<div class="intro"><h2>Rules: Long Version</h2>
	...
	Open a rule to expand it. Only one rule opens at a time.</p>
	</div>

	<details class="rules-section" name="server-rules">
		<summary>Rule One: Don't be a Dick</summary>
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Two: Please Use English</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Three: Keep Assistance in Assistance Channels</summary>
		<div class="rules-content">
			<ul>
				<li>Don't ask how to bypass network restrictions in place by Nintendo or game developers. This includes bypassing console bans.</li>
				<li>This also means that you should not DM others for help, ask to be DMed for help, or generally move assistance out of the server. There are many reasons for this, but the big 2 are:</li>
				<li>Keeping it here allows staff and other users to keep an eye on it, and counteract any misleading advice (even if well intentioned)</li>
				<li>It also allows the assistance interaction to be findable by others in the future, which can be useful for lots of reasons.</li>
			</ul>
		</div>
	</details>
	<div class="divider"></div>
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Four: Be Direct When Asking Questions</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Five: Don't Spam</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Six: Be Sensible in Assistance Channels</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Seven: Don't Start, or Bring, Drama Here</summary>
		<div class="rules-content">
			<p>Don't brigade, raid, or otherwise attack other people or communities, whether those people or communities are online or offline. Don't discuss participation in these attacks. This may warrant an immediate permanent ban.<br>
			In general, don't generate, participate in or start drama or controversy.<br>
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Eight: One Account Per Person</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Nine: Keep Server Discussions In-Server</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Ten: No NSFW, Shock or Objectionable Content</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Eleven: No Piracy or Other Copyright Violations</summary>
		<div class="rules-content">
			<p>Don't:</p>
			<ul>
			...
			<p>Software that is or might be free, such as updates and DLC, will usually still be restricted by copyright and should be treated as per this rule.</p>
		</div>
	</details>
	<div class="divider"></div>

	<details class="rules-section" name="server-rules">
		<summary>Rule Twelve: Don't Post Personal Information</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Thirteen: Don't Self-Promote Without Staff Permission</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Fourteen: Stick to the Channel Topics</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Fifteen: Keep Random Bot Commands in Bot Command Channels</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Sixteen: Evading or Loopholing Rules is Still Breaking Them</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Seventeen: Don't Talk, or Ask, About Leaks</summary>
		<div class="rules-content">
	...
	<details class="rules-section" name="server-rules">
		<summary>Rule Eighteen: Generative AI is Not Permitted Here</summary>
		<div class="rules-content">
